...
img_gaussian_noise = img_as_float(io.imread('images/noisy/noisy_salt_peakle.jpg', as_gray=True))
img_salt_pepper_noise = img_as_float(io.imread('images/noisy/noisy_salt_peakle.jpg', as_gray=True))

...
img = io.imread("Osteosarcoma_01.tif")
...
# img_gray = io.imread("Osteosarcoma_01.tif", as_gray=True)
# plt.imshow(img_gray, cmap="hot")
# plt.imshow(img_gray, cmap="RdPu")
# plt.show()
#
#
...
gray_img = cv2.imread("Osteosarcoma_01.tif", 0)
color_img = cv2.imread("Osteosarcoma_01.tif", 1)
